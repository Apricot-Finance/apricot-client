...
const LTVS: { [key in TokenID]?: number } = {
  ...
  [TokenID.USDC]: 0.90,
  [TokenID.UST]: 0,
  [TokenID.USTv2]: 0.0001,

  [TokenID.USDT_USDC_SABER]: 0.8,
  [TokenID.mSOL_SOL_SABER]: 0.0001,
  [TokenID.stSOL_SOL_SABER]: 0.0001,
  [TokenID.USDC_USDT_ORCA]: 0.0001,
  [TokenID.SOL_USDC_RAYDIUM]: 0.0001,
  [TokenID.RAY_USDC_RAYDIUM]: 0.0001,
  [TokenID.SOL_USDT_RAYDIUM]: 0.0001,
  [TokenID.SOL_USDC_ORCA]: 0.0001,
  [TokenID.mSOL_SOL_ORCA]: 0.0001,
  [TokenID.ORCA_USDC_ORCA]: 0.0001,
  [TokenID.ORCA_SOL_ORCA]: 0.0001,
  [TokenID.ETH_USDC_ORCA]: 0.0001,
  [TokenID.SOL_USDT_ORCA]: 0.0001,
  [TokenID.mSOL_SOL_RAYDIUM]: 0.0001,
  [TokenID.ETH_SOL_ORCA]: 0.0001,
  [TokenID.BTC_mSOL_ORCA]: 0.0001,
  [TokenID.mSOL_USDC_ORCA]: 0.0001,
  [TokenID.USTv2_USDC_SABER]: 0.0001,
  [TokenID.APT_USDC_ORCA]: 0.0001,
  [TokenID.RAY_USDT_RAYDIUM]: 0.0001,
  [TokenID.RAY_ETH_RAYDIUM]: 0.0001,
  [TokenID.RAY_SOL_RAYDIUM]: 0.0001,
  [TokenID.SRM_USDC_RAYDIUM]: 0.0001,
  [TokenID.stSOL_USTv2_ORCA]: 0.0001,
  [TokenID.ORCA_whETH_ORCA]: 0.0001,
};
...
export const DIRECT_SWAP_META: { [key in TokenID]?: { [key in TokenID]?: AdhocSwapInfo } } = {
  [TokenID.SOL]: {
    [TokenID.USDC]: {
      ...
      getSwapKeys: (_isBuy: boolean) => {
        const smeta = RAYDIUM_SOL_USDC_MARKET;
        // prettier-ignore
        return [
  ...
  [TokenID.mSOL]: {
    [TokenID.USDC]: {
      targetSwap: SWAP_RAYDIUM,
      getSwapKeys: (_isBuy: boolean) => {
        const smeta = RAYDIUM_mSOL_USDC_MARKET;
        // prettier-ignore
        return [
          {pubkey: RAYDIUM_AMM_PROGRAM,   isSigner: false, isWritable: false},
          {pubkey: smeta.amm,              isSigner: false, isWritable: true},
  ...
  [TokenID.RAY]: {
    [TokenID.USDC]: {
      targetSwap: SWAP_RAYDIUM,
      getSwapKeys: (_isBuy: boolean) => {
        const smeta = RAYDIUM_RAY_USDC_MARKET;
        // prettier-ignore
        return [
          {pubkey: RAYDIUM_AMM_PROGRAM,   isSigner: false, isWritable: false},
          {pubkey: smeta.amm,              isSigner: false, isWritable: true},
  ...
  [TokenID.stSOL]: {
    [TokenID.USDC]: {
      targetSwap: SWAP_RAYDIUM,
      getSwapKeys: (_isBuy: boolean) => {
        const smeta = RAYDIUM_stSOL_USDC_MARKET;
        // prettier-ignore
        return [
          {pubkey: RAYDIUM_AMM_PROGRAM,    isSigner: false, isWritable: false},
          {pubkey: smeta.amm,              isSigner: false, isWritable: true},
  ...
  [TokenID.whETH]: {
    [TokenID.USDC]: {
      targetSwap: SWAP_RAYDIUM,
      getSwapKeys: (_isBuy: boolean) => {
        const smeta = RAYDIUM_whETH_USDC_MARKET;
        // prettier-ignore
        return [
          {pubkey: RAYDIUM_AMM_PROGRAM,    isSigner: false, isWritable: false},
          {pubkey: smeta.amm,              isSigner: false, isWritable: true},
  ...
  [TokenID.ORCA]: {
    [TokenID.USDC]: {
      ...
      getSwapKeys: (isBuy: boolean) => {
        const smeta = ORCA_ORCA_USDC_MARKET;
  ...
  [TokenID.USDT]: {
    [TokenID.USDC]: {
      targetSwap: SWAP_ORCA,
      getSwapKeys: (isBuy: boolean) => {
        const smeta = ORCA_USDT_USDC_MARKET;
        const sourceVault = !isBuy ? smeta.vaultA : smeta.vaultB;
        const destVault = isBuy ? smeta.vaultA : smeta.vaultB;
        // prettier-ignore
        return [
  ...
  [TokenID.UST]: {
    [TokenID.USDC]: {
      targetSwap: SWAP_MERCURIAL,
      getSwapKeys: () => {
        const smeta = MERCURIAL_USTv1_USDC_MARKET;
        // prettier-ignore
        return [
          {pubkey: MERCURIAL_SWAP_PROGRAM,    isSigner: false, isWritable: false},
          {pubkey: smeta.swap,            isSigner: false, isWritable: false},
          {pubkey: smeta.swapAuthority,   isSigner: false, isWritable: false},
  ...
  [TokenID.USTv2]: {
    [TokenID.USDC]: {
      targetSwap: SWAP_SABER,
      getSwapKeys: (isBuy: boolean) => {
        const smeta = SABER_USTv2_USDC_MARKET;
        const sourceVault = !isBuy ? smeta.swapVaultA : smeta.swapVaultB;
        const destVault = isBuy ? smeta.swapVaultA : smeta.swapVaultB;
        const adminFeeDestination = isBuy ? smeta.adminFeeDestinationA : smeta.adminFeeDestinationB;
        // prettier-ignore
        return [
          {pubkey: SABER_SWAP_PROGRAM,    isSigner: false, isWritable: false},
          {pubkey: smeta.swap,            isSigner: false, isWritable: false},
          {pubkey: smeta.swapAuthority,   isSigner: false, isWritable: false},
          {pubkey: sourceVault,           isSigner: false, isWritable: true},
          {pubkey: destVault,             isSigner: false, isWritable: true},
  ...
  [TokenID.APT]: {
    [TokenID.USDC]: {
      targetSwap: SWAP_RAYDIUM,
      getSwapKeys: (_isBuy: boolean) => {
        const smeta = RAYDIUM_APT_USDC_MARKET;
        // prettier-ignore
        return [
          {pubkey: RAYDIUM_AMM_PROGRAM,   isSigner: false, isWritable: false},
          {pubkey: smeta.amm,              isSigner: false, isWritable: true},
  ...
  [TokenID.SRM]: {
    [TokenID.USDC]: {
      targetSwap: SWAP_RAYDIUM,
      getSwapKeys: (_isBuy: boolean) => {
        const smeta = RAYDIUM_SRM_USDC_MARKET;
        // prettier-ignore
        return [
          {pubkey: RAYDIUM_AMM_PROGRAM,   isSigner: false, isWritable: false},
          {pubkey: smeta.amm,              isSigner: false, isWritable: true},
  ...
  [TokenID.FTT]: {
    [TokenID.USDC]: {
      targetSwap: SWAP_ORCA,
      getSwapKeys: (isBuy: boolean) => {
        const smeta = ORCA_FTT_USDC_MARKET;
        const sourceVault = !isBuy ? smeta.vaultA : smeta.vaultB;
        const destVault = isBuy ? smeta.vaultA : smeta.vaultB;
        // prettier-ignore
        return [
  ...
  [TokenID.scnSOL]: {
    [TokenID.USDC]: {
      targetSwap: SWAP_ORCA,
      getSwapKeys: (isBuy: boolean) => {
        const smeta = ORCA_scnSOL_USDC_MARKET;
        const sourceVault = !isBuy ? smeta.vaultA : smeta.vaultB;
        const destVault = isBuy ? smeta.vaultA : smeta.vaultB;
        // prettier-ignore
        return [
