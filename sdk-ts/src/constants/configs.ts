...
const INTEREST_RATES: { [key in TokenID]?: InterestRate } = {
  ...
  [TokenID.scnSOL]: new InterestRate(0.02, 0.85, 0.2, 2.0),
...
export const RAYDIUM_LP_METAS: { [key in TokenID]?: RaydiumLpSwapInfo } = {
  [TokenID.SOL_USDC_RAYDIUM]: new RaydiumLpSwapInfo({
    ...
    ammTargetOrderPubkey: new PublicKey('CZza3Ej4Mc58MnxWA385itCC9jCo3L1D7zc3LKy1bZMR'),
  ...
  [TokenID.RAY_USDC_RAYDIUM]: new RaydiumLpSwapInfo({
    ...
    ammTargetOrderPubkey: new PublicKey('3cji8XW5uhtsA757vELVFAeJpskyHwbnTSceMFY5GjVT'),
  ...
  [TokenID.SOL_USDT_RAYDIUM]: new RaydiumLpSwapInfo({
    ...
    ammTargetOrderPubkey: new PublicKey('9x4knb3nuNAzxsV7YFuGLgnYqKArGemY54r2vFExM1dp'),
    ...
    serumCoinVaultAccount: new PublicKey('29cTsXahEoEBwbHwVc59jToybFpagbBMV6Lh45pWEmiK'),
  ...
  [TokenID.mSOL_SOL_RAYDIUM]: new RaydiumLpSwapInfo({
    ...
    ammTargetOrderPubkey: new PublicKey('CLuMpSesLPqdxewQTxfiLdifQfDfRsxkFhPgiChmdGfk'),
    ...
    poolTempLpTokenAccount: new PublicKey('ACn8TZ27fQ85kgdPKUfkETB4dS5JPFoq53z7uCgtHDai'),

    serumProgramId: new PublicKey('9xQeWvG816bUx9EPjHmaT23yvVM2ZWbrrpZb9PusVFin'),
    serumMarketPubkey: new PublicKey('5cLrMai1DsLRYc1Nio9qMTicsWtvzjzZfJPXyAoF4t1Z'),
    serumCoinVaultAccount: new PublicKey('2qmHPJn3URkrboLiJkQ5tBB4bmYWdb6MyhQzZ6ms7wf9'),
  ...
  [TokenID.RAY_USDT_RAYDIUM]: new RaydiumLpSwapInfo({
    ...
    ammTargetOrderPubkey: new PublicKey('3K2uLkKwVVPvZuMhcQAPLF8hw95somMeNwJS7vgWYrsJ'),
    ...
    serumCoinVaultAccount: new PublicKey('2kVNVEgHicvfwiyhT2T51YiQGMPFWLMSp8qXc1hHzkpU'),
  ...
  [TokenID.RAY_ETH_RAYDIUM]: new RaydiumLpSwapInfo({
    ...
    ammTargetOrderPubkey: new PublicKey('JChSqhn6yyEWqD95t8UR5DaZZtEZ1RGGjdwgMc8S6UUt'),
    ...
    serumCoinVaultAccount: new PublicKey('EVVtYo4AeCbmn2dYS1UnhtfjpzCXCcN26G1HmuHwMo7w'),
  ...
  [TokenID.RAY_SOL_RAYDIUM]: new RaydiumLpSwapInfo({
    ...
    ammTargetOrderPubkey: new PublicKey('5hATcCfvhVwAjNExvrg8rRkXmYyksHhVajWLa46iRsmE'),
    ...
    serumCoinVaultAccount: new PublicKey('6U6U59zmFWrPSzm9sLX7kVkaK78Kz7XJYkrhP1DjF3uF'),
  ...
  [TokenID.SRM_USDC_RAYDIUM]: new RaydiumLpSwapInfo({
    ...
    ammTargetOrderPubkey: new PublicKey('26LLpo8rscCpMxyAnJsqhqESPnzjMGiFdmXA4eF2Jrk5'),
    ...
    serumCoinVaultAccount: new PublicKey('Ecfy8et9Mft9Dkavnuh4mzHMa2KWYUbBTA5oDZNoWu84'),
