...
const LTVS: { [key in TokenID]?: number } = {
  ...
  [TokenID.mSOL_SOL_SABER]: 0.4,
  [TokenID.stSOL_SOL_SABER]: 0.4,
  [TokenID.USDC_USDT_ORCA]: 0.4,
  [TokenID.SOL_USDC_RAYDIUM]: 0.4,
  [TokenID.RAY_USDC_RAYDIUM]: 0.4,
  [TokenID.SOL_USDT_RAYDIUM]: 0.4,
  [TokenID.SOL_USDC_ORCA]: 0.4,
  [TokenID.mSOL_SOL_ORCA]: 0.4,
  [TokenID.ORCA_USDC_ORCA]: 0.4,
  [TokenID.ORCA_SOL_ORCA]: 0.4,
  [TokenID.ETH_USDC_ORCA]: 0.4,
  [TokenID.SOL_USDT_ORCA]: 0.4,
  [TokenID.mSOL_SOL_RAYDIUM]: 0.4,
  [TokenID.ETH_SOL_ORCA]: 0.4,
  [TokenID.BTC_mSOL_ORCA]: 0.4,
  [TokenID.mSOL_USDC_ORCA]: 0.4,
  [TokenID.USTv2_USDC_SABER]: 0.0001,
  [TokenID.APT_USDC_ORCA]: 0.4,
  [TokenID.RAY_USDT_RAYDIUM]: 0.4,
  [TokenID.RAY_ETH_RAYDIUM]: 0.4,
  [TokenID.RAY_SOL_RAYDIUM]: 0.4,
  [TokenID.SRM_USDC_RAYDIUM]: 0.4,
  [TokenID.stSOL_USTv2_ORCA]: 0.0001,
  [TokenID.ORCA_whETH_ORCA]: 0.4,
};
